...
<body class="nihilo">
	<div align="center" class="tituloFormulario">Registro de Productos</div>
	<div align="center">
	...
	<script type="dojo/method" event="onSubmit">
		...
		<table width="600" border="0" align="center" height="350px">
			...
			<tr>
				...
				<td align="left">
					<select name="cboTalla" id="cboTalla" dojoType="dijit.form.FilteringSelect" autocomplete="true" required="true">
