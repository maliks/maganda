...
<title>Modificar Mobiliarios</title>
...
<body class="nihilo">
	...
	<div align="center" class="tituloFormulario">Modificar Mobiliario</div>
	<div align="center">
	...
	<div dojoType="dijit.form.Form" id="myForm" jsId="myForm" action="${pageContext.request.contextPath}/grabarMobiliario.mgd" method="post">
		...
		<table width="400" border="0" align="center">
			...
			<tr>
				<td align="right">Identificador del mobiliario:</td>
				<td align="left">
					<input
						type="text"
						name="txtIdMobiliario"
						id="txtIdMobiliario"
						required="true"
						value="<c:out value="${mobiliario.idmobiliario}"/>"
						readonly="readonly"
			...
			<tr>
				...
				<td align="left">
					<input
						...
						id="txtNombre"
						required="true"
						value="<c:out value="${mobiliario.nombre}"/>"
						trim="true"
						maxlength="30"
						uppercase="true"
						dojoType="dijit.form.ValidationTextBox"
			...
			<tr>
				...
				<td align="left">
					<input
						...
						id="txtCantidad"
						required="true"
						value="<c:out value="${mobiliario.cantidad}"/>"
						trim="true"
						regExp="^[1-9]\d+$"
						maxlength="5"
						dojoType="dijit.form.ValidationTextBox"
				...
				<td align="left">
					<textarea
						...
						id="txtDireccion"
						maxlength="250"
						value="<c:out value="${mobiliario.descripcion}"/>"
						required="true"
						uppercase="true"
			...
			<tr>
				...
				<td align="left">
					<input
						...
						regExp="^\d+(\.\d{1,2})?$"
						maxlength="10"
						value="<c:out value="${mobiliario.monto}"/>"
						required="true"
						dojoType="dijit.form.ValidationTextBox"/>
				</td>
			</tr>
			<tr>
				...
				<td align="left">
					<input type="text" name="fecRegistroCompra" id="fecRegistroCompra" dojoType="dijit.form.DateTextBox" required="true" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${mobiliario.feccompra}" />" />
				</td>
			...
			<tr>
				...
				<td align="left">
					<select name="cboEstado" id="cboEstado" dojoType="dijit.form.FilteringSelect" autocomplete="true" required="true">
						<option value="1" <c:if test="${mobiliario.estado=='1'}">selected="selected"</c:if>>Activo</option>
						<option value="0" <c:if test="${mobiliario.estado=='0'}">selected="selected"</c:if>>Baja</option>
				</select>
				</td>
